...
const Bookings = (props) => {
    ...
    if (props.bookings.length > 0) {
      processedBookings = props.bookings.sort((a, b) => {
    ...
    const searchOn = Utils.sanitiseString(props.searchString);
      ...
      <div className="bookings">
        <h4>{props.sellerName}</h4>
        {
          processedBookings.length > 0
            ...
            searchOn.length > 0 
            ?
              <div className="bookings__text"><p>No bookings match your search term '{props.searchString}'.</p></div>
            : 
